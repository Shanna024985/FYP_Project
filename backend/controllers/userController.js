...
module.exports.createUserProfile = (req, res, next) => {
    let { 
        userId, first_name, last_name, phone_number, email,
    ...
    return userModel.userProfileExists(userId)
        .then(function(existing) {
            ...
            return userModel.createUserProfile({
                user_id: userId,
...
module.exports.updateUserProfile = (req, res, next) => {
    ...
    return userModel.userProfileExists(userId)
        .then(function(existing) {
            ...
            return userModel.updateUserProfile(userId, {
                first_name, last_name, phone_number, email,
                linkedin_profile, github_profile
        ...
        return userModel.userProfileExists(userId)
            .then(function(existing) {
                ...
                cloudinary.uploader.upload(dataURI, {
                    ...
                    return userModel.updateProfilePhoto(userId, fileName, fileData)
                        .then(function(updated) {
                            if (updated.length === 0) {
                                return res.status(404).json({ 
                                    error: "User profile not found" 
                            ...
                            res.status(201).json({
                                ...
                                profile: {
                                    ...
                                    profile_picture_file_name: updated[0].profile_picture_file_name,
...
module.exports.deleteProfilePhoto = (req, res, next) => {
    ...
    return userModel.userProfileExists(userId)
        .then(function(existing) {
            ...
            return userModel.deleteProfilePhoto(userId)
