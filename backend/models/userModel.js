...
module.exports.createProfileFromGoogleEmail = (userId, googleEmail) => {
    let sql = "INSERT INTO user_detail (user_id, email) VALUES ($1, $2) RETURNING id;";
    return query(sql, [userId, googleEmail]).then(function (result) {
        return result.rows;
    });
}
